...
public class DatabaseMutator extends DatabaseManipulator {
	...
	/**
	 *
	 * This handles only equality in the WHERE clause. This method assumes that
	 * all the values are of Text type and so no separate type indicators are
	 * necessary
	 *
	 * returns a count of the number of rows deleted
	 */
	// ------------------------------------------------------------
	public int deleteFromDatabase(String tableName, Properties whereValues) throws InvalidReturnValueException {
		return deleteFromDatabase(tableName, whereValues, null);
	}

	/**
	 *
	 * This handles only equality in the WHERE clause. This also assumes that
	 * the 'whereTypes' Properties object will contain an indication of numeric
	 * types for those column values that are numeric. For Text types, no entry
	 * in this Properties object is necessary.
	 *
	 * returns a count of the number of rows deleted
	 */
	// ------------------------------------------------------------
	public int deleteFromDatabase(String tableName, Properties whereValues, Properties whereTypes)
		...
		// DEBUG System.out.println("The delete statement = " +
		// theSQLStatement);
	...
	/**
	 *
	 * This method enables insertion of a set of values into a table. It assumes
	 * that all the values inserted are of Text type
	 *
	 * returns a count of the number of rows inserted
	 */
	// ------------------------------------------------------------
	public int insertIntoDatabase(String tableName, Properties insertValues) throws InvalidReturnValueException {
		return insertIntoDatabase(tableName, insertValues, null);
	}

	/**
	 *
	 * This method assumes that the values to be inserted are indicated along
	 * with their column names (column names are a MUST - no positional stuff is
	 * allowed at this point). Further, if the type of the value is numeric,
	 * that must be indicated in the 'insertTypes' parameter
	 *
	 * returns a count of the number of rows inserted
	 */
	// ------------------------------------------------------------
	public int insertIntoDatabase(String tableName, Properties insertValues, Properties insertTypes)
			throws InvalidReturnValueException {
		// Begin construction of the actual SQL statement
	...
	/**
	 *
	 * This method assumes that the values to be updated are indicated along
	 * with their column names. Further, all the update values are of Text type.
	 * Same logic applies to the WHERE clause
	 *
	 * returns a count of the number of rows updated
	 */
	// ------------------------------------------------------------
	public int updateDatabase(String tableName, Properties updateValues, Properties whereValues)
			throws InvalidReturnValueException {
	 ...
	 *
	 * This method assumes that the values to be updated are indicated along
	 * with their column names. Further, if the type of the value is numeric,
	 * that must be indicated in the 'updateTypes' parameter. Same logic applies
	 * to the WHERE clause
	 *
	 * returns a count of the number of rows updated
	 */
	// ------------------------------------------------------------
	public int updateDatabase(String tableName, Properties updateValues, Properties updateTypes, Properties whereValues,
			Properties whereTypes) throws InvalidReturnValueException {
	...
	/**
	 *
	 * Returns a return code for the number of rows inserted, updated or deleted
	...
	public Integer executeSQLMutateStatement() {
		...
		try {
			...
			// "executeSQLMutateStatement", "SQL Exception: " +
	...
	protected Object executeTheActualStatement() throws SQLException {
		if (theDBConnection != null) {
			...
			// The method executeQuery executes a insert/update/delete query on
			// the database.
			// The return value is the number of rows inserted, updated or
			// deleted in
			// the database
